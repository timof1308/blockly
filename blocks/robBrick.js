...
Blockly.Blocks['robBrick_colour'] = {
    ...
    init : function() {
        this.setColour(Blockly.CAT_SENSOR_RGB);
        var sensorPosition = new Blockly.FieldDropdown([ [ Blockly.Msg.SLOT_FRONT, 'FRONT' ], [ Blockly.Msg.SLOT_LEFT, 'LEFT' ], [ Blockly.Msg.SLOT_RIGHT, 'RIGHT' ], [ Blockly.Msg.SLOT_BACK, 'BACK' ] ]);
